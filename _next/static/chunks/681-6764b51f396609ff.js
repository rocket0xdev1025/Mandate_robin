...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [681],
  {
    5681: (e, t, r) => {
      ...
      let l = {
        ...
        u = {
          variadic: function (e, t) {
            var r, i;
            return (
              (r = t.cache.create()), (i = t.serializer), o.bind(this, e, r, i)
            );
          },
          monadic: function (e, t) {
            var r, i;
            return (
              (r = t.cache.create()), (i = t.serializer), s.bind(this, e, r, i)
            );
          },
        };
      ...
      function g(e) {
        return {
          getDateTimeFormat: p(Intl.DateTimeFormat, e.dateTime),
          getNumberFormat: p(Intl.NumberFormat, e.number),
          getPluralRules: p(Intl.PluralRules, e.pluralRules),
          getRelativeTimeFormat: p(Intl.RelativeTimeFormat, e.relativeTime),
          getListFormat: p(Intl.ListFormat, e.list),
          getDisplayNames: p(Intl.DisplayNames, e.displayNames),
        };
      }
      let b =
      ...
      var z = class {
        ...
        parseMessage(e, t, r) {
          ...
          for (; !this.isEOF(); ) {
            ...
            if (123 === n) {
              ...
              this.bump(),
                i.push({ type: I.pound, location: K(e, this.clonePosition()) });
            } else if (60 !== n || this.ignoreTag || 47 !== this.peek())
              if (60 === n && !this.ignoreTag && Q(this.peek() || 0)) {
            ...
            return this.error(S.INVALID_TAG, K(r, this.clonePosition()));
          {
              ...
              return this.error(S.UNCLOSED_TAG, K(r, this.clonePosition()));
            {
              if (this.isEOF() || !Q(this.char()))
                return this.error(S.INVALID_TAG, K(o, this.clonePosition()));
              let e = this.clonePosition();
              return i !== this.parseTagName()
                ...
                : this.error(S.INVALID_TAG, K(o, this.clonePosition()));
            }
          }
        }
        parseTagName() {
        ...
        parseLiteral(e, t) {
          ...
          return { val: { type: I.literal, value: i, location: n }, err: null };
        }
        ...
        parseArgument(e, t) {
          ...
          if (125 === this.char())
            return (
              this.bump(),
              this.error(S.EMPTY_ARGUMENT, K(r, this.clonePosition()))
            );
        ...
        parseIdentifierIfPossible() {
          ...
          let t = this.clonePosition(),
            ...
            n = r + i.length;
          return (
            this.bumpTo(n), { value: i, location: K(t, this.clonePosition()) }
          );
        }
        parseArgumentOptions(e, t, r, i) {
          ...
          switch (s) {
            case "":
              return this.error(S.EXPECT_ARGUMENT_TYPE, K(n, o));
            case "number":
            case "date":
            case "time": {
              this.bumpSpace();
              ...
              if (this.bumpIf(",")) {
                ...
                e = { style: i, styleLocation: K(t, this.clonePosition()) };
              }
              let t = this.tryParseArgumentClose(i);
              if (t.err) return t;
              let n = K(i, this.clonePosition());
              if (e && e.style.startsWith("::")) {
                let t = j(e.style.slice(2));
                if ("number" === s) {
                  let i = this.parseNumberSkeletonFromString(
                    t,
                    e.styleLocation
                  );
                  if (i.err) return i;
                ...
                {
                  if (0 === t.length)
                    return this.error(S.EXPECT_DATE_TIME_SKELETON, n);
                  let i = t;
                  this.locale &&
                    (i = (function (e, t) {
                      let r = "";
                      for (let i = 0; i < e.length; i++) {
                        ...
                        if ("j" === n) {
                          let s = 0;
                          for (; i + 1 < e.length && e.charAt(i + 1) === n; )
                            s++, i++;
                          let o = 1 + (1 & s),
                            h = s < 2 ? 1 : 3 + (s >> 1),
                            a = (function (e) {
              ...
              return {
                val: {
                  type:
                    "number" === s ? I.number : "date" === s ? I.date : I.time,
                  value: r,
                  location: n,
                  style: e?.style ?? null,
                },
            ...
            default:
              return this.error(S.INVALID_ARGUMENT_TYPE, K(n, o));
          }
        }
        ...
        parseNumberSkeletonFromString(e, t) {
          ...
          try {
            r = (function (e) {
              ...
              let t = e.split(T).filter((e) => e.length > 0),
                r = [];
              for (let e of t) {
                let t = e.split("/");
                    ...
                    for (let r of e) {
                      switch (r.stem) {
                        ...
                        case "integer-width":
                          ...
                          r.options[0].replace(B, function (e, r, i, n, s, o) {
                      ...
                      if (H.test(r.stem)) {
                        ...
                        r.stem.replace(H, function (e, r, i, n, s, o) {
                          return (
                            "*" === i
                              ...
                              ? ((t.minimumFractionDigits = s.length),
                                (t.maximumFractionDigits = s.length + o.length))
                              : ((t.minimumFractionDigits = r.length),
          ...
          for (;;) {
            if (0 === h.length) {
              ...
              if ("select" !== t && this.bumpIf("=")) {
                ...
                if (t.err) return t;
                (a = K(e, this.clonePosition())),
                  (h = this.message.slice(e.offset, this.offset()));
              } else break;
            }
            if (o.has(h))
              return this.error(
            ...
            if (u.err) return u;
            s.push([h, { value: l.val, location: K(i, this.clonePosition()) }]),
              o.add(h),
              this.bumpSpace(),
              ({ value: h, location: a } = this.parseIdentifierIfPossible());
          }
          return 0 === s.length
            ? this.error(
                "select" === t
        ...
        tryParseDecimalInteger(e, t) {
          ...
          for (; !this.isEOF(); ) {
            let e = this.char();
            if (e >= 48 && e <= 57)
              (n = !0), (s = 10 * s + (e - 48)), this.bump();
            else break;
          }
          let o = K(i, this.clonePosition());
          return n
            ? Number.isSafeInteger((s *= r))
              ? { val: s, err: null }
              : this.error(t, o)
            : this.error(e, o);
        }
      ...
      function q(e, t = {}) {
        ...
        if (r.err) {
          let e = SyntaxError(S[r.err.kind]);
          throw (
      ...
      var ee = class extends Error {
        ...
        et = class extends ee {
          constructor(e, t, r, i) {
            super(
              `Invalid values for "${e}": "${t}". Options are "${Object.keys(
                r
              ).join('", "')}"`,
              J.INVALID_VALUE,
              i
        ...
        er = class extends ee {
          constructor(e, t, r) {
            super(`Value for "${e}" must be of type ${t}`, J.INVALID_VALUE, r);
          }
        },
        ei = class extends ee {
          constructor(e, t) {
      ...
      let en = (function (e) {
        return (
          (e[(e.literal = 0)] = "literal"), (e[(e.object = 1)] = "object"), e
        );
      })({});
      function es(e) {
        return {
        ...
        constructor(t, r = e.defaultLocale, i, s) {
          if (
            ...
            (this.formatToParts = (e) =>
              (function e(t, r, i, n, s, o, h) {
                if (1 === t.length && M(t[0]))
                  return [{ type: en.literal, value: t[0].value }];
                let a = [];
                for (let l of t) {
                  if (M(l)) {
                    a.push({ type: en.literal, value: l.value });
                    continue;
                  }
                  if (l.type === I.pound) {
                    "number" == typeof o &&
                  ...
                  let { value: t } = l;
                  if (!(s && t in s)) throw new ei(t, h);
                  let u = s[t];
                  if (l.type === I.argument) {
                    (u &&
                      "string" != typeof u &&
                      "number" != typeof u &&
                      "bigint" != typeof u) ||
                      (u =
                        ...
                        "bigint" == typeof u
                          ...
                          : ""),
                      a.push({
                        type: "string" == typeof u ? en.literal : en.object,
                        value: u,
                      });
                    continue;
                  }
                  ...
                  if (v(l)) {
                    let { children: t, value: u } = l,
                      c = s[u];
                    if ("function" != typeof c) throw new er(u, "function", h);
                    let m = c(e(t, r, i, n, s, o).map((e) => e.value));
                    Array.isArray(m) || (m = [m]),
                      a.push(
                        ...m.map((e) => ({
                          type: "string" == typeof e ? en.literal : en.object,
                          value: e,
                        }))
                      );
                  }
                  if (O(l)) {
                    ...
                    if (!o) throw new et(l.value, u, Object.keys(l.options), h);
...
`,
                ...
                return a.length < 2
                  ...
                  : a.reduce((e, t) => {
                      let r = e[e.length - 1];
                      return (
                        r && r.type === en.literal && t.type === en.literal
                          ? (r.value += t.value)
                          : e.push(t),
                        e
                      );
            ...
            let { ...r } = s || {};
            this.ast = e.__parse(t, { ...r, locale: this.resolvedLocale });
          } else this.ast = t;
              ...
              (function (e = { number: {}, dateTime: {}, pluralRules: {} }) {
                return {
                  ...
                  getDateTimeFormat: n(
                    ...
                    { cache: es(e.dateTime), strategy: u.variadic }
                  ),
                  getPluralRules: n((...e) => new Intl.PluralRules(...e), {
                    cache: es(e.pluralRules),
                    strategy: u.variadic,
                  }),
                };
              })(this.formatterCache));
      ...
      function eh(...[e, t, r, n]) {
        ...
        a.getMessageFormat ||
          (a.getMessageFormat = E(
            (...e) => new eo(e[0], e[1], e[2], { formatters: a, ...e[3] }),
            o.message
          ));
        try {
          s = a.getMessageFormat(
            t,
            u,
            (function (e, t, r) {
              let i = eo.formats.date,
                n = eo.formats.time,
                s = { ...e?.dateTime, ...t?.dateTime },
                o = {
                  date: { ...i, ...s },
                  time: { ...n, ...s },
            ...
            })(l, h, f),
            {
              formatters: {
                ...
                getDateTimeFormat: (e, t) =>
                  a.getDateTimeFormat(e, { ...t, timeZone: t?.timeZone ?? f }),
              },
            }
          );
        } catch (e) {
      ...
      var ef = r(8095);
      let eE = (0, i.createContext)(void 0);
      function ep({
        children: e,
        formats: t,
        ...
        let l = (0, i.useContext)(eE),
          u = (0, i.useMemo)(() => l?.cache || f(), [n, l?.cache]),
          c = (0, i.useMemo)(() => l?.formatters || g(u), [u, l?.formatters]),
          m = (0, i.useMemo)(
            () => ({
              ...(function ({
                formats: e,
        ...
        return (0, ef.jsx)(eE.Provider, { value: m, children: e });
      }
      function eg() {
      ...
      function eH(e) {
        return (function (e, t, r) {
          let {
            ...
            f = e["!"],
            E = "!" === t ? void 0 : t.slice((r + ".").length);
          return (
            u ||
              eb ||
              !eT ||
              ((eb = !0), l(new c(m.ENVIRONMENT_FALLBACK, void 0))),
            (0, i.useMemo)(
              () =>
                (function (e) {
                  ...
                  return (function ({
                    ...
                    function f(e, t, r, i) {
                      let s = new c(t, r);
                      return a(s), i ?? n({ error: s, key: e, namespace: h });
                    }
                    function E(E, p, g, b) {
                      let T;
                      if (u) {
                        if (!b)
                          return a(o), n({ error: o, key: E, namespace: h });
                        T = b;
                      } else
                        try {
                          T = ec(s, o, E, h);
                        } catch (e) {
                          if (!b) return f(E, m.MISSING_MESSAGE, e.message, b);
                          T = b;
                        }
                      try {
                        let n = ea(h, E);
                        ...
                        return (
                          r instanceof c
                            ...
                            : ((e = m.FORMATTING_ERROR), (t = r.message)),
                          f(E, e, t, b)
                        );
                      }
                    }
                    function p(e, t, r, i) {
                      ...
                      return "string" != typeof n
                        ? f(e, m.INVALID_MESSAGE, void 0)
                        : n;
                    }
                    return (
                      (p.rich = E),
                      (p.markup = (e, t, r, i) => E(e, t, r, i)),
                      (p.raw = (e) => {
                        if (u)
                          return a(o), n({ error: o, key: e, namespace: h });
                        try {
            ...
            (function (e) {
              ...
              function h(e) {
                return (
                  e?.timeZone ||
                    (o
                      ? (e = { ...e, timeZone: o })
                      : s(new c(m.ENVIRONMENT_FALLBACK, void 0))),
                  e
                );
              }
              function a(e, t, r, i, n) {
                ...
                try {
                  ...
                  return s(new c(m.FORMATTING_ERROR, e.message)), n();
                }
              }
              function l(e, t, s) {
                return a(
                  ...
                  s,
                  i?.dateTime,
                  (t) => ((t = h(t)), r.getDateTimeFormat(n, t).format(e)),
                  () => String(e)
                );
              }
              function u() {
                return e.now
                  ? e.now
                  : (s(new c(m.ENVIRONMENT_FALLBACK, void 0)), new Date());
              }
              return {
                dateTime: l,
                ...
                relativeTime: function (e, t) {
                  try {
                    ...
                    t instanceof Date || "number" == typeof t
                      ? (s = new Date(t))
                      : t &&
                        ((s = null != t.now ? new Date(t.now) : u()),
                        (o = t.unit),
                        (h.style = t.style),
                        (h.numberingSystem = t.numberingSystem)),
                      s || (s = u());
                    let a = (new Date(e).getTime() - s.getTime()) / 1e3;
                    o ||
                      (o = (function (e) {
                        let t = Math.abs(e);
                        return t < 60
                      ...
                      (h.numeric = "second" === o ? "auto" : "always");
                    let l = ((i = o), Math.round(a / em[i]));
                    return r.getRelativeTimeFormat(n, h).format(l, o);
                  } catch (t) {
                    return s(new c(m.FORMATTING_ERROR, t.message)), String(e);
                  }
                },
                list: function (e, t, s) {
                  let o = [],
                ...
                dateTimeRange: function (e, t, s, o) {
                  return a(
                    s,
                    o,
                    i?.dateTime,
                    (i) => (
                      (i = h(i)), r.getDateTimeFormat(n, i).formatRange(e, t)
                    ),
                    () => [l(e), l(t)].join(" – ")
                  );
                },
                displayName: function (e, t, s) {
                  return a(
                    t,
                    s,
                    i?.displayName,
                    (t) => r.getDisplayNames(n, t).of(e),
                    () => e
                  );
                },
              };
