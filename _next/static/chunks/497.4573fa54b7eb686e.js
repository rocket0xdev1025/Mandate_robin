    ...
    4497: (t, i, e) => {
      ...
      var n = class {
          ...
          fromTo(
            t,
            i,
            { lerp: e, duration: s, easing: o, onStart: n, onUpdate: r }
          ) {
        ...
        l = class {
          ...
          on(t, i) {
            return (
              this.events[t] ? this.events[t].push(i) : (this.events[t] = [i]),
              () => {
      ...
      var p = class {
        ...
        onTouchStart = (t) => {
          let { clientX: i, clientY: e } = t.targetTouches
            ? t.targetTouches[0]
            : t;
          (this.touchStart.x = i),
            (this.touchStart.y = e),
      ...
      let d = (t) => Math.min(1, 1.001 - 2 ** (-10 * t));
      var u = class {
        _isScrolling = !1;
        _isStopped = !1;
        _isLocked = !1;
        ...
        constructor({
          ...
          gestureOrientation: w = "horizontal" === v ? "both" : "vertical",
          touchMultiplier: S = 1,
          wheelMultiplier: f = 1,
          autoResize: g = !0,
          prevent: y,
          ...
          (window.lenisVersion = s),
            ...
            "number" == typeof a && "function" != typeof c
              ? (c = d)
              : "function" == typeof c && "number" != typeof a && (a = 1),
            (this.options = {
              wrapper: t,
              content: i,
              eventsTarget: e,
            ...
            (this.dimensions = new r(t, i, { autoResize: g })),
        ...
        onClick = (t) => {
          ...
          if (this.options.anchors) {
            let t = i.find(
              (t) => e.host === t.host && e.pathname === t.pathname && t.hash
            );
            if (t) {
              let i =
          ...
          if (
            ...
            i.some((t) => e.host === t.host && e.pathname !== t.pathname)
          )
        ...
        onVirtualScroll = (t) => {
          if (
            ...
            return;
          let { deltaX: i, deltaY: e, event: s } = t;
          if (
          ...
          let a = this.options.prevent,
            c = Math.abs(i) >= Math.abs(e) ? "horizontal" : "vertical";
          if (
            h.find(
              (t) =>
                ...
                (("function" == typeof a && a?.(t)) ||
                  ...
                  (this.options.allowNestedScroll &&
                    this.hasNestedScroll(t, { deltaX: i, deltaY: e })))
            )
          )
            return;
          ...
          "both" === this.options.gestureOrientation
            ? (p = Math.abs(e) > Math.abs(i) ? e : i)
            : "horizontal" === this.options.gestureOrientation && (p = i),
        ...
        scrollTo(
          t,
          {
            ...
            easing: h = n ? this.options.easing : void 0,
            onStart: a,
            onComplete: c,
            force: p = !1,
            userData: u,
        ...
        hasNestedScroll(t, { deltaX: i, deltaY: e }) {
          ...
          if (g - (y.time ?? 0) > 2e3) {
            ...
            if (
              ((y.computedStyle = i),
              (s = ["auto", "overlay", "scroll"].includes(i.overflowX)),
              (o = ["auto", "overlay", "scroll"].includes(i.overflowY)),
              (l = ["auto"].includes(i.overscrollBehaviorX)),
              (h = ["auto"].includes(i.overscrollBehaviorY)),
              (y.hasOverflowX = s),
              (y.hasOverflowY = o),
              !(s || o))
            )
          ...
          if (!((s && n) || (o && r))) return !1;
          let E = Math.abs(i) >= Math.abs(e) ? "horizontal" : "vertical";
          if ("horizontal" === E)
            (u = Math.round(t.scrollLeft)),
              (m = a - p),
              (v = i),
              (w = s),
              (S = n),
